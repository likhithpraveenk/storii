...
bool operator ==(Object other) {
  final _this = this as AudioFile;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is AudioFile&&(identical(other.ino, _this.ino) || other.ino == _this.ino)&&(identical(other.metadata, _this.metadata) || other.metadata == _this.metadata)&&(identical(other.index, _this.index) || other.index == _this.index)&&(identical(other.addedAt, _this.addedAt) || other.addedAt == _this.addedAt)&&(identical(other.updatedAt, _this.updatedAt) || other.updatedAt == _this.updatedAt)&&(identical(other.trackNumFromMeta, _this.trackNumFromMeta) || other.trackNumFromMeta == _this.trackNumFromMeta)&&(identical(other.discNumFromMeta, _this.discNumFromMeta) || other.discNumFromMeta == _this.discNumFromMeta)&&(identical(other.trackNumFromFilename, _this.trackNumFromFilename) || other.trackNumFromFilename == _this.trackNumFromFilename)&&(identical(other.discNumFromFilename, _this.discNumFromFilename) || other.discNumFromFilename == _this.discNumFromFilename)&&(identical(other.manuallyVerified, _this.manuallyVerified) || other.manuallyVerified == _this.manuallyVerified)&&(identical(other.exclude, _this.exclude) || other.exclude == _this.exclude)&&(identical(other.error, _this.error) || other.error == _this.error)&&(identical(other.format, _this.format) || other.format == _this.format)&&(identical(other.duration, _this.duration) || other.duration == _this.duration)&&(identical(other.bitRate, _this.bitRate) || other.bitRate == _this.bitRate)&&(identical(other.language, _this.language) || other.language == _this.language)&&(identical(other.codec, _this.codec) || other.codec == _this.codec)&&(identical(other.timeBase, _this.timeBase) || other.timeBase == _this.timeBase)&&(identical(other.channels, _this.channels) || other.channels == _this.channels)&&(identical(other.channelLayout, _this.channelLayout) || other.channelLayout == _this.channelLayout)&&const DeepCollectionEquality().equals(other.chapters, _this.chapters)&&(identical(other.embeddedCoverArt, _this.embeddedCoverArt) || other.embeddedCoverArt == _this.embeddedCoverArt)&&(identical(other.metaTags, _this.metaTags) || other.metaTags == _this.metaTags)&&(identical(other.mimeType, _this.mimeType) || other.mimeType == _this.mimeType));
}
...
int get hashCode {
  final _this = this as AudioFile;
  return Object.hashAll([runtimeType,_this.ino,_this.metadata,_this.index,_this.addedAt,_this.updatedAt,_this.trackNumFromMeta,_this.discNumFromMeta,_this.trackNumFromFilename,_this.discNumFromFilename,_this.manuallyVerified,_this.exclude,_this.error,_this.format,_this.duration,_this.bitRate,_this.language,_this.codec,_this.timeBase,_this.channels,_this.channelLayout,const DeepCollectionEquality().hash(_this.chapters),_this.embeddedCoverArt,_this.metaTags,_this.mimeType]);
}

@override
String toString() {
  final _this = this as AudioFile;
  return 'AudioFile(ino: ${_this.ino}, metadata: ${_this.metadata}, index: ${_this.index}, addedAt: ${_this.addedAt}, updatedAt: ${_this.updatedAt}, trackNumFromMeta: ${_this.trackNumFromMeta}, discNumFromMeta: ${_this.discNumFromMeta}, trackNumFromFilename: ${_this.trackNumFromFilename}, discNumFromFilename: ${_this.discNumFromFilename}, manuallyVerified: ${_this.manuallyVerified}, exclude: ${_this.exclude}, error: ${_this.error}, format: ${_this.format}, duration: ${_this.duration}, bitRate: ${_this.bitRate}, language: ${_this.language}, codec: ${_this.codec}, timeBase: ${_this.timeBase}, channels: ${_this.channels}, channelLayout: ${_this.channelLayout}, chapters: ${_this.chapters}, embeddedCoverArt: ${_this.embeddedCoverArt}, metaTags: ${_this.metaTags}, mimeType: ${_this.mimeType})';
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String ino,  FileMetadata metadata,  int? index,  DateTime? addedAt,  DateTime? updatedAt,  int? trackNumFromMeta,  int? discNumFromMeta,  int? trackNumFromFilename,  int? discNumFromFilename,  bool? manuallyVerified,  bool? exclude,  String? error,  String? format,  Duration? duration,  int? bitRate,  String? language,  String? codec,  String? timeBase,  int? channels,  String? channelLayout,  List<BookChapter> chapters,  String? embeddedCoverArt,  AudioMetaTags? metaTags,  String? mimeType)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AudioFile() when $default != null:
return $default(_that.ino,_that.metadata,_that.index,_that.addedAt,_that.updatedAt,_that.trackNumFromMeta,_that.discNumFromMeta,_that.trackNumFromFilename,_that.discNumFromFilename,_that.manuallyVerified,_that.exclude,_that.error,_that.format,_that.duration,_that.bitRate,_that.language,_that.codec,_that.timeBase,_that.channels,_that.channelLayout,_that.chapters,_that.embeddedCoverArt,_that.metaTags,_that.mimeType);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String ino,  FileMetadata metadata,  int? index,  DateTime? addedAt,  DateTime? updatedAt,  int? trackNumFromMeta,  int? discNumFromMeta,  int? trackNumFromFilename,  int? discNumFromFilename,  bool? manuallyVerified,  bool? exclude,  String? error,  String? format,  Duration? duration,  int? bitRate,  String? language,  String? codec,  String? timeBase,  int? channels,  String? channelLayout,  List<BookChapter> chapters,  String? embeddedCoverArt,  AudioMetaTags? metaTags,  String? mimeType)  $default,) {final _that = this;
switch (_that) {
case _AudioFile():
return $default(_that.ino,_that.metadata,_that.index,_that.addedAt,_that.updatedAt,_that.trackNumFromMeta,_that.discNumFromMeta,_that.trackNumFromFilename,_that.discNumFromFilename,_that.manuallyVerified,_that.exclude,_that.error,_that.format,_that.duration,_that.bitRate,_that.language,_that.codec,_that.timeBase,_that.channels,_that.channelLayout,_that.chapters,_that.embeddedCoverArt,_that.metaTags,_that.mimeType);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String ino,  FileMetadata metadata,  int? index,  DateTime? addedAt,  DateTime? updatedAt,  int? trackNumFromMeta,  int? discNumFromMeta,  int? trackNumFromFilename,  int? discNumFromFilename,  bool? manuallyVerified,  bool? exclude,  String? error,  String? format,  Duration? duration,  int? bitRate,  String? language,  String? codec,  String? timeBase,  int? channels,  String? channelLayout,  List<BookChapter> chapters,  String? embeddedCoverArt,  AudioMetaTags? metaTags,  String? mimeType)?  $default,) {final _that = this;
switch (_that) {
case _AudioFile() when $default != null:
return $default(_that.ino,_that.metadata,_that.index,_that.addedAt,_that.updatedAt,_that.trackNumFromMeta,_that.discNumFromMeta,_that.trackNumFromFilename,_that.discNumFromFilename,_that.manuallyVerified,_that.exclude,_that.error,_that.format,_that.duration,_that.bitRate,_that.language,_that.codec,_that.timeBase,_that.channels,_that.channelLayout,_that.chapters,_that.embeddedCoverArt,_that.metaTags,_that.mimeType);case _:
  return null;
...
/// Create a copy of AudioFile
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? ino = null,Object? metadata = null,Object? index = freezed,Object? addedAt = freezed,Object? updatedAt = freezed,Object? trackNumFromMeta = freezed,Object? discNumFromMeta = freezed,Object? trackNumFromFilename = freezed,Object? discNumFromFilename = freezed,Object? manuallyVerified = freezed,Object? exclude = freezed,Object? error = freezed,Object? format = freezed,Object? duration = freezed,Object? bitRate = freezed,Object? language = freezed,Object? codec = freezed,Object? timeBase = freezed,Object? channels = freezed,Object? channelLayout = freezed,Object? chapters = null,Object? embeddedCoverArt = freezed,Object? metaTags = freezed,Object? mimeType = freezed,}) {
