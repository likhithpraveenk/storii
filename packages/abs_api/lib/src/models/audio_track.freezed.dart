...
int get hashCode {
  final _this = this as AudioTrack;
  return Object.hashAll([runtimeType,_this.index,_this.startOffset,_this.duration,_this.title,_this.contentUrl,_this.mimeType,_this.metadata,_this.ino,_this.addedAt,_this.updatedAt,_this.trackNumFromMeta,_this.discNumFromMeta,_this.trackNumFromFilename,_this.discNumFromFilename,_this.manuallyVerified,_this.exclude,_this.error,_this.format,_this.bitRate,_this.language,_this.codec,_this.timeBase,_this.channels,_this.channelLayout,const DeepCollectionEquality().hash(_this.chapters),_this.embeddedCoverArt,_this.metaTags]);
}

@override
String toString() {
  final _this = this as AudioTrack;
  return 'AudioTrack(index: ${_this.index}, startOffset: ${_this.startOffset}, duration: ${_this.duration}, title: ${_this.title}, contentUrl: ${_this.contentUrl}, mimeType: ${_this.mimeType}, metadata: ${_this.metadata}, ino: ${_this.ino}, addedAt: ${_this.addedAt}, updatedAt: ${_this.updatedAt}, trackNumFromMeta: ${_this.trackNumFromMeta}, discNumFromMeta: ${_this.discNumFromMeta}, trackNumFromFilename: ${_this.trackNumFromFilename}, discNumFromFilename: ${_this.discNumFromFilename}, manuallyVerified: ${_this.manuallyVerified}, exclude: ${_this.exclude}, error: ${_this.error}, format: ${_this.format}, bitRate: ${_this.bitRate}, language: ${_this.language}, codec: ${_this.codec}, timeBase: ${_this.timeBase}, channels: ${_this.channels}, channelLayout: ${_this.channelLayout}, chapters: ${_this.chapters}, embeddedCoverArt: ${_this.embeddedCoverArt}, metaTags: ${_this.metaTags})';
}
