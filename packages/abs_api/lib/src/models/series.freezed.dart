...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Series&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.name, _this.name) || other.name == _this.name)&&(identical(other.libraryId, _this.libraryId) || other.libraryId == _this.libraryId)&&(identical(other.nameIgnorePrefix, _this.nameIgnorePrefix) || other.nameIgnorePrefix == _this.nameIgnorePrefix)&&(identical(other.description, _this.description) || other.description == _this.description)&&(identical(other.addedAt, _this.addedAt) || other.addedAt == _this.addedAt)&&(identical(other.updatedAt, _this.updatedAt) || other.updatedAt == _this.updatedAt)&&const DeepCollectionEquality().equals(other.books, _this.books)&&(identical(other.numBooks, _this.numBooks) || other.numBooks == _this.numBooks)&&(identical(other.sequence, _this.sequence) || other.sequence == _this.sequence)&&(identical(other.seriesSequenceList, _this.seriesSequenceList) || other.seriesSequenceList == _this.seriesSequenceList)&&const DeepCollectionEquality().equals(other.libraryItemIds, _this.libraryItemIds)&&(identical(other.progress, _this.progress) || other.progress == _this.progress)&&(identical(other.inProgress, _this.inProgress) || other.inProgress == _this.inProgress)&&(identical(other.hasActiveBook, _this.hasActiveBook) || other.hasActiveBook == _this.hasActiveBook)&&(identical(other.hideFromContinueListening, _this.hideFromContinueListening) || other.hideFromContinueListening == _this.hideFromContinueListening)&&(identical(other.bookInProgressLastUpdate, _this.bookInProgressLastUpdate) || other.bookInProgressLastUpdate == _this.bookInProgressLastUpdate)&&(identical(other.firstBookUnread, _this.firstBookUnread) || other.firstBookUnread == _this.firstBookUnread));
}
...
int get hashCode {
  final _this = this as Series;
  return Object.hash(runtimeType,_this.id,_this.name,_this.libraryId,_this.nameIgnorePrefix,_this.description,_this.addedAt,_this.updatedAt,const DeepCollectionEquality().hash(_this.books),_this.numBooks,_this.sequence,_this.seriesSequenceList,const DeepCollectionEquality().hash(_this.libraryItemIds),_this.progress,_this.inProgress,_this.hasActiveBook,_this.hideFromContinueListening,_this.bookInProgressLastUpdate,_this.firstBookUnread);
}

@override
String toString() {
  final _this = this as Series;
  return 'Series(id: ${_this.id}, name: ${_this.name}, libraryId: ${_this.libraryId}, nameIgnorePrefix: ${_this.nameIgnorePrefix}, description: ${_this.description}, addedAt: ${_this.addedAt}, updatedAt: ${_this.updatedAt}, books: ${_this.books}, numBooks: ${_this.numBooks}, sequence: ${_this.sequence}, seriesSequenceList: ${_this.seriesSequenceList}, libraryItemIds: ${_this.libraryItemIds}, progress: ${_this.progress}, inProgress: ${_this.inProgress}, hasActiveBook: ${_this.hasActiveBook}, hideFromContinueListening: ${_this.hideFromContinueListening}, bookInProgressLastUpdate: ${_this.bookInProgressLastUpdate}, firstBookUnread: ${_this.firstBookUnread})';
}
