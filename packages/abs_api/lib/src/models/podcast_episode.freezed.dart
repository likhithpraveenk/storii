...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,libraryItemId,podcastId,id,index,season,episode,episodeType,title,subtitle,description,enclosure,pubDate,audioFile,publishedAt,addedAt,updatedAt,audioTrack,duration,size,const DeepCollectionEquality().hash(podcast)]);
