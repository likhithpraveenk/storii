...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ServerSettings&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.scannerFindCovers, _this.scannerFindCovers) || other.scannerFindCovers == _this.scannerFindCovers)&&(identical(other.scannerParseSubtitle, _this.scannerParseSubtitle) || other.scannerParseSubtitle == _this.scannerParseSubtitle)&&(identical(other.scannerPreferMatchedMetadata, _this.scannerPreferMatchedMetadata) || other.scannerPreferMatchedMetadata == _this.scannerPreferMatchedMetadata)&&(identical(other.scannerDisableWatcher, _this.scannerDisableWatcher) || other.scannerDisableWatcher == _this.scannerDisableWatcher)&&(identical(other.storeCoverWithItem, _this.storeCoverWithItem) || other.storeCoverWithItem == _this.storeCoverWithItem)&&(identical(other.storeMetadataWithItem, _this.storeMetadataWithItem) || other.storeMetadataWithItem == _this.storeMetadataWithItem)&&(identical(other.metadataFileFormat, _this.metadataFileFormat) || other.metadataFileFormat == _this.metadataFileFormat)&&(identical(other.rateLimitLoginRequests, _this.rateLimitLoginRequests) || other.rateLimitLoginRequests == _this.rateLimitLoginRequests)&&(identical(other.rateLimitLoginWindow, _this.rateLimitLoginWindow) || other.rateLimitLoginWindow == _this.rateLimitLoginWindow)&&(identical(other.backupsToKeep, _this.backupsToKeep) || other.backupsToKeep == _this.backupsToKeep)&&(identical(other.maxBackupSize, _this.maxBackupSize) || other.maxBackupSize == _this.maxBackupSize)&&(identical(other.loggerDailyLogsToKeep, _this.loggerDailyLogsToKeep) || other.loggerDailyLogsToKeep == _this.loggerDailyLogsToKeep)&&(identical(other.loggerScannerLogsToKeep, _this.loggerScannerLogsToKeep) || other.loggerScannerLogsToKeep == _this.loggerScannerLogsToKeep)&&(identical(other.homeBookshelfView, _this.homeBookshelfView) || other.homeBookshelfView == _this.homeBookshelfView)&&(identical(other.bookshelfView, _this.bookshelfView) || other.bookshelfView == _this.bookshelfView)&&(identical(other.sortingIgnorePrefix, _this.sortingIgnorePrefix) || other.sortingIgnorePrefix == _this.sortingIgnorePrefix)&&const DeepCollectionEquality().equals(other.sortingPrefixes, _this.sortingPrefixes)&&(identical(other.chromecastEnabled, _this.chromecastEnabled) || other.chromecastEnabled == _this.chromecastEnabled)&&(identical(other.dateFormat, _this.dateFormat) || other.dateFormat == _this.dateFormat)&&(identical(other.language, _this.language) || other.language == _this.language)&&(identical(other.logLevel, _this.logLevel) || other.logLevel == _this.logLevel)&&(identical(other.version, _this.version) || other.version == _this.version));
}
...
int get hashCode {
  final _this = this as ServerSettings;
  return Object.hashAll([runtimeType,_this.id,_this.scannerFindCovers,_this.scannerParseSubtitle,_this.scannerPreferMatchedMetadata,_this.scannerDisableWatcher,_this.storeCoverWithItem,_this.storeMetadataWithItem,_this.metadataFileFormat,_this.rateLimitLoginRequests,_this.rateLimitLoginWindow,_this.backupsToKeep,_this.maxBackupSize,_this.loggerDailyLogsToKeep,_this.loggerScannerLogsToKeep,_this.homeBookshelfView,_this.bookshelfView,_this.sortingIgnorePrefix,const DeepCollectionEquality().hash(_this.sortingPrefixes),_this.chromecastEnabled,_this.dateFormat,_this.language,_this.logLevel,_this.version]);
}

@override
String toString() {
  final _this = this as ServerSettings;
  return 'ServerSettings(id: ${_this.id}, scannerFindCovers: ${_this.scannerFindCovers}, scannerParseSubtitle: ${_this.scannerParseSubtitle}, scannerPreferMatchedMetadata: ${_this.scannerPreferMatchedMetadata}, scannerDisableWatcher: ${_this.scannerDisableWatcher}, storeCoverWithItem: ${_this.storeCoverWithItem}, storeMetadataWithItem: ${_this.storeMetadataWithItem}, metadataFileFormat: ${_this.metadataFileFormat}, rateLimitLoginRequests: ${_this.rateLimitLoginRequests}, rateLimitLoginWindow: ${_this.rateLimitLoginWindow}, backupsToKeep: ${_this.backupsToKeep}, maxBackupSize: ${_this.maxBackupSize}, loggerDailyLogsToKeep: ${_this.loggerDailyLogsToKeep}, loggerScannerLogsToKeep: ${_this.loggerScannerLogsToKeep}, homeBookshelfView: ${_this.homeBookshelfView}, bookshelfView: ${_this.bookshelfView}, sortingIgnorePrefix: ${_this.sortingIgnorePrefix}, sortingPrefixes: ${_this.sortingPrefixes}, chromecastEnabled: ${_this.chromecastEnabled}, dateFormat: ${_this.dateFormat}, language: ${_this.language}, logLevel: ${_this.logLevel}, version: ${_this.version})';
}
...
as bool?,scannerParseSubtitle: freezed == scannerParseSubtitle ? _self.scannerParseSubtitle : scannerParseSubtitle // ignore: cast_nullable_to_non_nullable
...
/// Create a copy of ServerSettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? scannerFindCovers = freezed,Object? scannerParseSubtitle = freezed,Object? scannerPreferMatchedMetadata = freezed,Object? scannerDisableWatcher = freezed,Object? storeCoverWithItem = freezed,Object? storeMetadataWithItem = freezed,Object? metadataFileFormat = freezed,Object? rateLimitLoginRequests = freezed,Object? rateLimitLoginWindow = freezed,Object? backupsToKeep = freezed,Object? maxBackupSize = freezed,Object? loggerDailyLogsToKeep = freezed,Object? loggerScannerLogsToKeep = freezed,Object? homeBookshelfView = freezed,Object? bookshelfView = freezed,Object? sortingIgnorePrefix = freezed,Object? sortingPrefixes = freezed,Object? chromecastEnabled = freezed,Object? dateFormat = freezed,Object? language = freezed,Object? logLevel = freezed,Object? version = freezed,}) {
