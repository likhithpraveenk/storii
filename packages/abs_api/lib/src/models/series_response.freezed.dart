...
class _SeriesResponse implements SeriesResponse {
  const _SeriesResponse({required  List<Series> results, required this.total, required this.limit, required this.page, this.sortBy, required this.sortDesc, this.filterBy, required this.minified, required this.include}): _results = results;
