...
class _MediaProgress implements MediaProgress {
  const _MediaProgress({required this.id, required this.libraryItemId, this.episodeId, @DurationPreciseSecondsConverter() required this.duration, this.progress, @DurationPreciseSecondsConverter()@JsonKey(readValue: _readDuration) required this.currentTime, required this.isFinished, required this.hideFromContinueListening, @DateTimeEpochConverter() required this.lastUpdate, @DateTimeEpochConverter() required this.startedAt, @DateTimeEpochConverter() this.finishedAt});
...
@override@DurationPreciseSecondsConverter()@JsonKey(readValue: _readDuration) final  Duration currentTime;
