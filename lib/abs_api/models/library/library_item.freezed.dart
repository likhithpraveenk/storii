...
mixin _$LibraryItem {
 ...
 String get id; String get libraryId; DateTime get addedAt; DateTime get updatedAt; bool get isMissing; MediaType get mediaType; Media get media; int get size; String? get sequence; String? get seriesSequence; MediaProgress? get userMediaProgress; List<PodcastEpisodeDownload>? get episodesDownloading;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,libraryId,addedAt,updatedAt,isMissing,mediaType,media,size,sequence,seriesSequence,userMediaProgress,const DeepCollectionEquality().hash(episodesDownloading));

@override
String toString() {
  return 'LibraryItem(id: $id, libraryId: $libraryId, addedAt: $addedAt, updatedAt: $updatedAt, isMissing: $isMissing, mediaType: $mediaType, media: $media, size: $size, sequence: $sequence, seriesSequence: $seriesSequence, userMediaProgress: $userMediaProgress, episodesDownloading: $episodesDownloading)';
}
...
@useResult
$Res call({
 String id, String libraryId, DateTime addedAt, DateTime updatedAt, bool isMissing, MediaType mediaType, Media media, int size, String? sequence, String? seriesSequence, MediaProgress? userMediaProgress, List<PodcastEpisodeDownload>? episodesDownloading
});


$MediaCopyWith<$Res> get media;$MediaProgressCopyWith<$Res>? get userMediaProgress;
...
/// Create a copy of LibraryItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? libraryId = null,Object? addedAt = null,Object? updatedAt = null,Object? isMissing = null,Object? mediaType = null,Object? media = null,Object? size = null,Object? sequence = freezed,Object? seriesSequence = freezed,Object? userMediaProgress = freezed,Object? episodesDownloading = freezed,}) {
...
as Media,size: null == size ? _self.size : size // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String libraryId,  DateTime addedAt,  DateTime updatedAt,  bool isMissing,  MediaType mediaType,  Media media,  int size,  String? sequence,  String? seriesSequence,  MediaProgress? userMediaProgress,  List<PodcastEpisodeDownload>? episodesDownloading)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LibraryItem() when $default != null:
return $default(_that.id,_that.libraryId,_that.addedAt,_that.updatedAt,_that.isMissing,_that.mediaType,_that.media,_that.size,_that.sequence,_that.seriesSequence,_that.userMediaProgress,_that.episodesDownloading);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String libraryId,  DateTime addedAt,  DateTime updatedAt,  bool isMissing,  MediaType mediaType,  Media media,  int size,  String? sequence,  String? seriesSequence,  MediaProgress? userMediaProgress,  List<PodcastEpisodeDownload>? episodesDownloading)  $default,) {final _that = this;
switch (_that) {
case _LibraryItem():
return $default(_that.id,_that.libraryId,_that.addedAt,_that.updatedAt,_that.isMissing,_that.mediaType,_that.media,_that.size,_that.sequence,_that.seriesSequence,_that.userMediaProgress,_that.episodesDownloading);}
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,libraryId,addedAt,updatedAt,isMissing,mediaType,media,size,sequence,seriesSequence,userMediaProgress,const DeepCollectionEquality().hash(_episodesDownloading));
...
@override $MediaCopyWith<$Res> get media;@override $MediaProgressCopyWith<$Res>? get userMediaProgress;
...
/// Create a copy of LibraryItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? libraryId = null,Object? addedAt = null,Object? updatedAt = null,Object? isMissing = null,Object? mediaType = null,Object? media = null,Object? size = null,Object? sequence = freezed,Object? seriesSequence = freezed,Object? userMediaProgress = freezed,Object? episodesDownloading = freezed,}) {
