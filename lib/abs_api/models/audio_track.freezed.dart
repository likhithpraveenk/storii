...
mixin _$AudioTrack {
 ...
 int get index; Duration get startOffset; String get title; String get contentUrl; String get mimeType; FileMetadata get metadata; String get ino; DateTime get addedAt; DateTime get updatedAt; int? get trackNumFromMeta; int? get discNumFromMeta; int? get trackNumFromFilename; int? get discNumFromFilename; bool get manuallyVerified; bool get exclude; String? get error; String? get format; Duration get duration; int get bitRate; String? get language; String get codec; String get timeBase; int get channels; String get channelLayout; List<BookChapter> get chapters; String? get embeddedCoverArt; AudioMetaTags get metaTags;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,index,startOffset,title,contentUrl,mimeType,metadata,ino,addedAt,updatedAt,trackNumFromMeta,discNumFromMeta,trackNumFromFilename,discNumFromFilename,manuallyVerified,exclude,error,format,duration,bitRate,language,codec,timeBase,channels,channelLayout,const DeepCollectionEquality().hash(chapters),embeddedCoverArt,metaTags]);

@override
String toString() {
  return 'AudioTrack(index: $index, startOffset: $startOffset, title: $title, contentUrl: $contentUrl, mimeType: $mimeType, metadata: $metadata, ino: $ino, addedAt: $addedAt, updatedAt: $updatedAt, trackNumFromMeta: $trackNumFromMeta, discNumFromMeta: $discNumFromMeta, trackNumFromFilename: $trackNumFromFilename, discNumFromFilename: $discNumFromFilename, manuallyVerified: $manuallyVerified, exclude: $exclude, error: $error, format: $format, duration: $duration, bitRate: $bitRate, language: $language, codec: $codec, timeBase: $timeBase, channels: $channels, channelLayout: $channelLayout, chapters: $chapters, embeddedCoverArt: $embeddedCoverArt, metaTags: $metaTags)';
}
...
/// Create a copy of AudioTrack
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? index = null,Object? startOffset = null,Object? title = null,Object? contentUrl = null,Object? mimeType = null,Object? metadata = null,Object? ino = null,Object? addedAt = null,Object? updatedAt = null,Object? trackNumFromMeta = freezed,Object? discNumFromMeta = freezed,Object? trackNumFromFilename = freezed,Object? discNumFromFilename = freezed,Object? manuallyVerified = null,Object? exclude = null,Object? error = freezed,Object? format = freezed,Object? duration = null,Object? bitRate = null,Object? language = freezed,Object? codec = null,Object? timeBase = null,Object? channels = null,Object? channelLayout = null,Object? chapters = null,Object? embeddedCoverArt = freezed,Object? metaTags = null,}) {
...
as FileMetadata,ino: null == ino ? _self.ino : ino // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int index,  Duration startOffset,  String title,  String contentUrl,  String mimeType,  FileMetadata metadata,  String ino,  DateTime addedAt,  DateTime updatedAt,  int? trackNumFromMeta,  int? discNumFromMeta,  int? trackNumFromFilename,  int? discNumFromFilename,  bool manuallyVerified,  bool exclude,  String? error,  String? format,  Duration duration,  int bitRate,  String? language,  String codec,  String timeBase,  int channels,  String channelLayout,  List<BookChapter> chapters,  String? embeddedCoverArt,  AudioMetaTags metaTags)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AudioTrack() when $default != null:
return $default(_that.index,_that.startOffset,_that.title,_that.contentUrl,_that.mimeType,_that.metadata,_that.ino,_that.addedAt,_that.updatedAt,_that.trackNumFromMeta,_that.discNumFromMeta,_that.trackNumFromFilename,_that.discNumFromFilename,_that.manuallyVerified,_that.exclude,_that.error,_that.format,_that.duration,_that.bitRate,_that.language,_that.codec,_that.timeBase,_that.channels,_that.channelLayout,_that.chapters,_that.embeddedCoverArt,_that.metaTags);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int index,  Duration startOffset,  String title,  String contentUrl,  String mimeType,  FileMetadata metadata,  String ino,  DateTime addedAt,  DateTime updatedAt,  int? trackNumFromMeta,  int? discNumFromMeta,  int? trackNumFromFilename,  int? discNumFromFilename,  bool manuallyVerified,  bool exclude,  String? error,  String? format,  Duration duration,  int bitRate,  String? language,  String codec,  String timeBase,  int channels,  String channelLayout,  List<BookChapter> chapters,  String? embeddedCoverArt,  AudioMetaTags metaTags)  $default,) {final _that = this;
switch (_that) {
case _AudioTrack():
return $default(_that.index,_that.startOffset,_that.title,_that.contentUrl,_that.mimeType,_that.metadata,_that.ino,_that.addedAt,_that.updatedAt,_that.trackNumFromMeta,_that.discNumFromMeta,_that.trackNumFromFilename,_that.discNumFromFilename,_that.manuallyVerified,_that.exclude,_that.error,_that.format,_that.duration,_that.bitRate,_that.language,_that.codec,_that.timeBase,_that.channels,_that.channelLayout,_that.chapters,_that.embeddedCoverArt,_that.metaTags);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int index,  Duration startOffset,  String title,  String contentUrl,  String mimeType,  FileMetadata metadata,  String ino,  DateTime addedAt,  DateTime updatedAt,  int? trackNumFromMeta,  int? discNumFromMeta,  int? trackNumFromFilename,  int? discNumFromFilename,  bool manuallyVerified,  bool exclude,  String? error,  String? format,  Duration duration,  int bitRate,  String? language,  String codec,  String timeBase,  int channels,  String channelLayout,  List<BookChapter> chapters,  String? embeddedCoverArt,  AudioMetaTags metaTags)?  $default,) {final _that = this;
switch (_that) {
case _AudioTrack() when $default != null:
return $default(_that.index,_that.startOffset,_that.title,_that.contentUrl,_that.mimeType,_that.metadata,_that.ino,_that.addedAt,_that.updatedAt,_that.trackNumFromMeta,_that.discNumFromMeta,_that.trackNumFromFilename,_that.discNumFromFilename,_that.manuallyVerified,_that.exclude,_that.error,_that.format,_that.duration,_that.bitRate,_that.language,_that.codec,_that.timeBase,_that.channels,_that.channelLayout,_that.chapters,_that.embeddedCoverArt,_that.metaTags);case _:
  return null;
...
class _AudioTrack implements AudioTrack {
  const _AudioTrack({required this.index, required this.startOffset, required this.title, required this.contentUrl, required this.mimeType, required this.metadata, required this.ino, required this.addedAt, required this.updatedAt, this.trackNumFromMeta, this.discNumFromMeta, this.trackNumFromFilename, this.discNumFromFilename, required this.manuallyVerified, required this.exclude, this.error, this.format, required this.duration, required this.bitRate, this.language, required this.codec, required this.timeBase, required this.channels, required this.channelLayout, required final  List<BookChapter> chapters, this.embeddedCoverArt, required this.metaTags}): _chapters = chapters;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,index,startOffset,title,contentUrl,mimeType,metadata,ino,addedAt,updatedAt,trackNumFromMeta,discNumFromMeta,trackNumFromFilename,discNumFromFilename,manuallyVerified,exclude,error,format,duration,bitRate,language,codec,timeBase,channels,channelLayout,const DeepCollectionEquality().hash(_chapters),embeddedCoverArt,metaTags]);
...
/// Create a copy of AudioTrack
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? index = null,Object? startOffset = null,Object? title = null,Object? contentUrl = null,Object? mimeType = null,Object? metadata = null,Object? ino = null,Object? addedAt = null,Object? updatedAt = null,Object? trackNumFromMeta = freezed,Object? discNumFromMeta = freezed,Object? trackNumFromFilename = freezed,Object? discNumFromFilename = freezed,Object? manuallyVerified = null,Object? exclude = null,Object? error = freezed,Object? format = freezed,Object? duration = null,Object? bitRate = null,Object? language = freezed,Object? codec = null,Object? timeBase = null,Object? channels = null,Object? channelLayout = null,Object? chapters = null,Object? embeddedCoverArt = freezed,Object? metaTags = null,}) {
