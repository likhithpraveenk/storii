...
class _LibraryItem implements LibraryItem {
  const _LibraryItem({required this.id, required this.libraryId, required this.addedAt, required this.updatedAt, required this.isMissing, required this.mediaType, required this.media, this.size, this.sequence, this.seriesSequence, this.userMediaProgress, final  List<PodcastEpisodeDownload>? episodesDownloading}): _episodesDownloading = episodesDownloading;
