...
mixin _$PlaybackEvent {
 ...
 DateTime get timestamp; Duration get position; PlaybackEventKind get kind; Duration get listened; bool get syncAttempt; bool get syncSuccess; bool get playbackError;
...
@useResult
$Res call({
 DateTime timestamp, Duration position, PlaybackEventKind kind, Duration listened, bool syncAttempt, bool syncSuccess, bool playbackError
});
...
/// Create a copy of PlaybackEvent
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? timestamp = null,Object? position = null,Object? kind = null,Object? listened = null,Object? syncAttempt = null,Object? syncSuccess = null,Object? playbackError = null,}) {
  return _then(PlaybackEvent(
...
as PlaybackEventKind,listened: null == listened ? _self.listened : listened // ignore: cast_nullable_to_non_nullable
as Duration,syncAttempt: null == syncAttempt ? _self.syncAttempt : syncAttempt // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( DateTime timestamp,  Duration position,  PlaybackEventKind kind,  Duration listened,  bool syncAttempt,  bool syncSuccess,  bool playbackError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlaybackEvent() when $default != null:
return $default(_that.timestamp,_that.position,_that.kind,_that.listened,_that.syncAttempt,_that.syncSuccess,_that.playbackError);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( DateTime timestamp,  Duration position,  PlaybackEventKind kind,  Duration listened,  bool syncAttempt,  bool syncSuccess,  bool playbackError)  $default,) {final _that = this;
switch (_that) {
case _PlaybackEvent():
return $default(_that.timestamp,_that.position,_that.kind,_that.listened,_that.syncAttempt,_that.syncSuccess,_that.playbackError);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( DateTime timestamp,  Duration position,  PlaybackEventKind kind,  Duration listened,  bool syncAttempt,  bool syncSuccess,  bool playbackError)?  $default,) {final _that = this;
switch (_that) {
case _PlaybackEvent() when $default != null:
return $default(_that.timestamp,_that.position,_that.kind,_that.listened,_that.syncAttempt,_that.syncSuccess,_that.playbackError);case _:
  return null;
...
class _PlaybackEvent implements PlaybackEvent {
  const _PlaybackEvent({required this.timestamp, required this.position, required this.kind, this.listened = Duration.zero, this.syncAttempt = false, this.syncSuccess = false, this.playbackError = false});
...
@override@JsonKey() final  Duration listened;
...
/// Create a copy of PlaybackEvent
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? timestamp = null,Object? position = null,Object? kind = null,Object? listened = null,Object? syncAttempt = null,Object? syncSuccess = null,Object? playbackError = null,}) {
