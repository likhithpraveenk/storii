...
mixin _$SeriesDomain {
 ...
 String get id; String get name; String get libraryId; String? get sequence; String? get nameIgnorePrefix; String? get description; DateTime? get addedAt; DateTime? get updatedAt; bool get isFinished; List<ItemDomain>? get books; List<String>? get libraryItemIdsFinished;
...
@override
int get hashCode => Object.hash(runtimeType,id,name,libraryId,sequence,nameIgnorePrefix,description,addedAt,updatedAt,isFinished,const DeepCollectionEquality().hash(books),const DeepCollectionEquality().hash(libraryItemIdsFinished));

@override
String toString() {
  return 'SeriesDomain(id: $id, name: $name, libraryId: $libraryId, sequence: $sequence, nameIgnorePrefix: $nameIgnorePrefix, description: $description, addedAt: $addedAt, updatedAt: $updatedAt, isFinished: $isFinished, books: $books, libraryItemIdsFinished: $libraryItemIdsFinished)';
}
...
@useResult
$Res call({
 String id, String name, String libraryId, String? sequence, String? nameIgnorePrefix, String? description, DateTime? addedAt, DateTime? updatedAt, bool isFinished, List<ItemDomain>? books, List<String>? libraryItemIdsFinished
});
...
/// Create a copy of SeriesDomain
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? libraryId = null,Object? sequence = freezed,Object? nameIgnorePrefix = freezed,Object? description = freezed,Object? addedAt = freezed,Object? updatedAt = freezed,Object? isFinished = null,Object? books = freezed,Object? libraryItemIdsFinished = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String name,  String libraryId,  String? sequence,  String? nameIgnorePrefix,  String? description,  DateTime? addedAt,  DateTime? updatedAt,  bool isFinished,  List<ItemDomain>? books,  List<String>? libraryItemIdsFinished)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SeriesDomain() when $default != null:
return $default(_that.id,_that.name,_that.libraryId,_that.sequence,_that.nameIgnorePrefix,_that.description,_that.addedAt,_that.updatedAt,_that.isFinished,_that.books,_that.libraryItemIdsFinished);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String name,  String libraryId,  String? sequence,  String? nameIgnorePrefix,  String? description,  DateTime? addedAt,  DateTime? updatedAt,  bool isFinished,  List<ItemDomain>? books,  List<String>? libraryItemIdsFinished)  $default,) {final _that = this;
switch (_that) {
case _SeriesDomain():
return $default(_that.id,_that.name,_that.libraryId,_that.sequence,_that.nameIgnorePrefix,_that.description,_that.addedAt,_that.updatedAt,_that.isFinished,_that.books,_that.libraryItemIdsFinished);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String name,  String libraryId,  String? sequence,  String? nameIgnorePrefix,  String? description,  DateTime? addedAt,  DateTime? updatedAt,  bool isFinished,  List<ItemDomain>? books,  List<String>? libraryItemIdsFinished)?  $default,) {final _that = this;
switch (_that) {
case _SeriesDomain() when $default != null:
return $default(_that.id,_that.name,_that.libraryId,_that.sequence,_that.nameIgnorePrefix,_that.description,_that.addedAt,_that.updatedAt,_that.isFinished,_that.books,_that.libraryItemIdsFinished);case _:
  return null;
...
class _SeriesDomain implements SeriesDomain {
  const _SeriesDomain({required this.id, required this.name, required this.libraryId, this.sequence, this.nameIgnorePrefix, this.description, this.addedAt, this.updatedAt, this.isFinished = false, final  List<ItemDomain>? books, final  List<String>? libraryItemIdsFinished}): _books = books,_libraryItemIdsFinished = libraryItemIdsFinished;
...
@override
int get hashCode => Object.hash(runtimeType,id,name,libraryId,sequence,nameIgnorePrefix,description,addedAt,updatedAt,isFinished,const DeepCollectionEquality().hash(_books),const DeepCollectionEquality().hash(_libraryItemIdsFinished));
...
/// Create a copy of SeriesDomain
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? libraryId = null,Object? sequence = freezed,Object? nameIgnorePrefix = freezed,Object? description = freezed,Object? addedAt = freezed,Object? updatedAt = freezed,Object? isFinished = null,Object? books = freezed,Object? libraryItemIdsFinished = freezed,}) {
