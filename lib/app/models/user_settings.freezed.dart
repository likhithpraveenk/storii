...
@noCodeGen String get userId; String? get currentLibraryId; String? get activeItemId; List<NavTarget> get navTargets; bool get isFullySynced; bool get isItemsGridView; bool get isSeriesGridView; bool get isAuthorsGridView; bool get showTitleForItem; bool get stackTitleOnImage; Duration get fastForward; Duration get rewind; double get speed;
...
@useResult
$Res call({
@noCodeGen String userId, String? currentLibraryId, String? activeItemId, List<NavTarget> navTargets, bool isFullySynced, bool isItemsGridView, bool isSeriesGridView, bool isAuthorsGridView, bool showTitleForItem, bool stackTitleOnImage, Duration fastForward, Duration rewind, double speed
});
...
/// Create a copy of UserSettings
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? currentLibraryId = freezed,Object? activeItemId = freezed,Object? navTargets = null,Object? isFullySynced = null,Object? isItemsGridView = null,Object? isSeriesGridView = null,Object? isAuthorsGridView = null,Object? showTitleForItem = null,Object? stackTitleOnImage = null,Object? fastForward = null,Object? rewind = null,Object? speed = null,}) {
...
as String?,activeItemId: freezed == activeItemId ? _self.activeItemId : activeItemId // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@noCodeGen  String userId,  String? currentLibraryId,  String? activeItemId,  List<NavTarget> navTargets,  bool isFullySynced,  bool isItemsGridView,  bool isSeriesGridView,  bool isAuthorsGridView,  bool showTitleForItem,  bool stackTitleOnImage,  Duration fastForward,  Duration rewind,  double speed)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _UserSettings() when $default != null:
return $default(_that.userId,_that.currentLibraryId,_that.activeItemId,_that.navTargets,_that.isFullySynced,_that.isItemsGridView,_that.isSeriesGridView,_that.isAuthorsGridView,_that.showTitleForItem,_that.stackTitleOnImage,_that.fastForward,_that.rewind,_that.speed);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@noCodeGen  String userId,  String? currentLibraryId,  String? activeItemId,  List<NavTarget> navTargets,  bool isFullySynced,  bool isItemsGridView,  bool isSeriesGridView,  bool isAuthorsGridView,  bool showTitleForItem,  bool stackTitleOnImage,  Duration fastForward,  Duration rewind,  double speed)  $default,) {final _that = this;
switch (_that) {
case _UserSettings():
return $default(_that.userId,_that.currentLibraryId,_that.activeItemId,_that.navTargets,_that.isFullySynced,_that.isItemsGridView,_that.isSeriesGridView,_that.isAuthorsGridView,_that.showTitleForItem,_that.stackTitleOnImage,_that.fastForward,_that.rewind,_that.speed);}
}
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@noCodeGen  String userId,  String? currentLibraryId,  String? activeItemId,  List<NavTarget> navTargets,  bool isFullySynced,  bool isItemsGridView,  bool isSeriesGridView,  bool isAuthorsGridView,  bool showTitleForItem,  bool stackTitleOnImage,  Duration fastForward,  Duration rewind,  double speed)?  $default,) {final _that = this;
switch (_that) {
case _UserSettings() when $default != null:
return $default(_that.userId,_that.currentLibraryId,_that.activeItemId,_that.navTargets,_that.isFullySynced,_that.isItemsGridView,_that.isSeriesGridView,_that.isAuthorsGridView,_that.showTitleForItem,_that.stackTitleOnImage,_that.fastForward,_that.rewind,_that.speed);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UserSettings&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.currentLibraryId, currentLibraryId) || other.currentLibraryId == currentLibraryId)&&(identical(other.activeItemId, activeItemId) || other.activeItemId == activeItemId)&&const DeepCollectionEquality().equals(other._navTargets, _navTargets)&&(identical(other.isFullySynced, isFullySynced) || other.isFullySynced == isFullySynced)&&(identical(other.isItemsGridView, isItemsGridView) || other.isItemsGridView == isItemsGridView)&&(identical(other.isSeriesGridView, isSeriesGridView) || other.isSeriesGridView == isSeriesGridView)&&(identical(other.isAuthorsGridView, isAuthorsGridView) || other.isAuthorsGridView == isAuthorsGridView)&&(identical(other.showTitleForItem, showTitleForItem) || other.showTitleForItem == showTitleForItem)&&(identical(other.stackTitleOnImage, stackTitleOnImage) || other.stackTitleOnImage == stackTitleOnImage)&&(identical(other.fastForward, fastForward) || other.fastForward == fastForward)&&(identical(other.rewind, rewind) || other.rewind == rewind)&&(identical(other.speed, speed) || other.speed == speed));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,userId,currentLibraryId,activeItemId,const DeepCollectionEquality().hash(_navTargets),isFullySynced,isItemsGridView,isSeriesGridView,isAuthorsGridView,showTitleForItem,stackTitleOnImage,fastForward,rewind,speed);
...
/// Create a copy of UserSettings
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? currentLibraryId = freezed,Object? activeItemId = freezed,Object? navTargets = null,Object? isFullySynced = null,Object? isItemsGridView = null,Object? isSeriesGridView = null,Object? isAuthorsGridView = null,Object? showTitleForItem = null,Object? stackTitleOnImage = null,Object? fastForward = null,Object? rewind = null,Object? speed = null,}) {
