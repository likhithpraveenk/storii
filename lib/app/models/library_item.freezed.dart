...
mixin _$LibraryItem {
 ...
 String get id; String get libraryId; DateTime get addedAt; DateTime get updatedAt; bool get isMissing; int get size; String? get title; String? get description; String? get language; bool get explicit; List<String> get genres; List<String> get tags; double get progress; bool get isFinished; bool get hideFromContinueListening;
...
@override
int get hashCode => Object.hash(runtimeType,id,libraryId,addedAt,updatedAt,isMissing,size,title,description,language,explicit,const DeepCollectionEquality().hash(genres),const DeepCollectionEquality().hash(tags),progress,isFinished,hideFromContinueListening);

@override
String toString() {
  return 'LibraryItem(id: $id, libraryId: $libraryId, addedAt: $addedAt, updatedAt: $updatedAt, isMissing: $isMissing, size: $size, title: $title, description: $description, language: $language, explicit: $explicit, genres: $genres, tags: $tags, progress: $progress, isFinished: $isFinished, hideFromContinueListening: $hideFromContinueListening)';
}
...
@useResult
$Res call({
 String id, String libraryId, DateTime addedAt, DateTime updatedAt, bool isMissing, int size, String? title, String? description, String? language, bool explicit, List<String> genres, List<String> tags, double progress, bool isFinished, bool hideFromContinueListening
});
...
class Audiobook extends LibraryItem {
  const Audiobook({required this.id, required this.libraryId, required this.addedAt, required this.updatedAt, required this.isMissing, required this.size, required this.duration, this.title, final  List<Author> authors = const [], this.description, this.language, this.explicit = false, final  List<String> narrators = const [], final  List<String> genres = const [], final  List<String> tags = const [], final  List<AudioFile> audioFiles = const [], final  List<AudioTrack> tracks = const [], final  List<BookChapter> chapters = const [], this.progress = 0, this.isFinished = false, this.hideFromContinueListening = false}): _authors = authors,_narrators = narrators,_genres = genres,_tags = tags,_audioFiles = audioFiles,_tracks = tracks,_chapters = chapters,super._();
...
@override
int get hashCode => Object.hashAll([runtimeType,id,libraryId,addedAt,updatedAt,isMissing,size,duration,title,const DeepCollectionEquality().hash(_authors),description,language,explicit,const DeepCollectionEquality().hash(_narrators),const DeepCollectionEquality().hash(_genres),const DeepCollectionEquality().hash(_tags),const DeepCollectionEquality().hash(_audioFiles),const DeepCollectionEquality().hash(_tracks),const DeepCollectionEquality().hash(_chapters),progress,isFinished,hideFromContinueListening]);

@override
String toString() {
  return 'LibraryItem.audiobook(id: $id, libraryId: $libraryId, addedAt: $addedAt, updatedAt: $updatedAt, isMissing: $isMissing, size: $size, duration: $duration, title: $title, authors: $authors, description: $description, language: $language, explicit: $explicit, narrators: $narrators, genres: $genres, tags: $tags, audioFiles: $audioFiles, tracks: $tracks, chapters: $chapters, progress: $progress, isFinished: $isFinished, hideFromContinueListening: $hideFromContinueListening)';
}
...
as List<Author>,description: freezed == description ? _self.description : description // ignore: cast_nullable_to_non_nullable
as String?,language: freezed == language ? _self.language : language // ignore: cast_nullable_to_non_nullable
as String?,explicit: null == explicit ? _self.explicit : explicit // ignore: cast_nullable_to_non_nullable
