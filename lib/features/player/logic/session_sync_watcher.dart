...
const _source = 'SessionSyncWatcher';
...
class SessionSyncWatcher extends _$SessionSyncWatcher {
  ...
  void build() {
    ...
    ref.listen(sessionProvider, (_, session) async {
      ...
      _service = PlaybackSyncService(
        ...
        audioEvents: audioHandler.events,
      ...
      LogService.log('session started: ${session.id}', source: _source);
    });
