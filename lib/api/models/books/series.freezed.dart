...
mixin _$Series {
 ...
 List<LibraryItem> get books; List<String>? get libraryItemIds; int? get numBooks;// Sequence & Sorting
...
/// Create a copy of Series
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? libraryId = null,Object? nameIgnorePrefix = freezed,Object? description = freezed,Object? addedAt = null,Object? updatedAt = null,Object? books = null,Object? libraryItemIds = freezed,Object? numBooks = freezed,Object? sequence = freezed,Object? seriesSequenceList = freezed,Object? progress = freezed,Object? inProgress = freezed,Object? hasActiveBook = freezed,Object? hideFromContinueListening = freezed,Object? bookInProgressLastUpdate = freezed,Object? firstBookUnread = freezed,Object? rssFeed = freezed,}) {
...
as List<LibraryItem>,libraryItemIds: freezed == libraryItemIds ? _self.libraryItemIds : libraryItemIds // ignore: cast_nullable_to_non_nullable
...
class _Series implements Series {
  const _Series({required this.id, required this.name, required this.libraryId, this.nameIgnorePrefix, this.description, required this.addedAt, required this.updatedAt, final  List<LibraryItem> books = const [], final  List<String>? libraryItemIds, this.numBooks, this.sequence, this.seriesSequenceList, this.progress, this.inProgress, this.hasActiveBook, this.hideFromContinueListening, this.bookInProgressLastUpdate, this.firstBookUnread, this.rssFeed}): _books = books,_libraryItemIds = libraryItemIds;
...
// Content / Collections
@override@JsonKey() List<LibraryItem> get books {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Series&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.libraryId, libraryId) || other.libraryId == libraryId)&&(identical(other.nameIgnorePrefix, nameIgnorePrefix) || other.nameIgnorePrefix == nameIgnorePrefix)&&(identical(other.description, description) || other.description == description)&&(identical(other.addedAt, addedAt) || other.addedAt == addedAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&const DeepCollectionEquality().equals(other._books, _books)&&const DeepCollectionEquality().equals(other._libraryItemIds, _libraryItemIds)&&(identical(other.numBooks, numBooks) || other.numBooks == numBooks)&&(identical(other.sequence, sequence) || other.sequence == sequence)&&(identical(other.seriesSequenceList, seriesSequenceList) || other.seriesSequenceList == seriesSequenceList)&&(identical(other.progress, progress) || other.progress == progress)&&(identical(other.inProgress, inProgress) || other.inProgress == inProgress)&&(identical(other.hasActiveBook, hasActiveBook) || other.hasActiveBook == hasActiveBook)&&(identical(other.hideFromContinueListening, hideFromContinueListening) || other.hideFromContinueListening == hideFromContinueListening)&&(identical(other.bookInProgressLastUpdate, bookInProgressLastUpdate) || other.bookInProgressLastUpdate == bookInProgressLastUpdate)&&(identical(other.firstBookUnread, firstBookUnread) || other.firstBookUnread == firstBookUnread)&&(identical(other.rssFeed, rssFeed) || other.rssFeed == rssFeed));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,name,libraryId,nameIgnorePrefix,description,addedAt,updatedAt,const DeepCollectionEquality().hash(_books),const DeepCollectionEquality().hash(_libraryItemIds),numBooks,sequence,seriesSequenceList,progress,inProgress,hasActiveBook,hideFromContinueListening,bookInProgressLastUpdate,firstBookUnread,rssFeed]);
...
/// Create a copy of Series
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? libraryId = null,Object? nameIgnorePrefix = freezed,Object? description = freezed,Object? addedAt = null,Object? updatedAt = null,Object? books = null,Object? libraryItemIds = freezed,Object? numBooks = freezed,Object? sequence = freezed,Object? seriesSequenceList = freezed,Object? progress = freezed,Object? inProgress = freezed,Object? hasActiveBook = freezed,Object? hideFromContinueListening = freezed,Object? bookInProgressLastUpdate = freezed,Object? firstBookUnread = freezed,Object? rssFeed = freezed,}) {
...
as List<LibraryItem>,libraryItemIds: freezed == libraryItemIds ? _self._libraryItemIds : libraryItemIds // ignore: cast_nullable_to_non_nullable
as List<String>?,numBooks: freezed == numBooks ? _self.numBooks : numBooks // ignore: cast_nullable_to_non_nullable
as int?,sequence: freezed == sequence ? _self.sequence : sequence // ignore: cast_nullable_to_non_nullable
as String?,seriesSequenceList: freezed == seriesSequenceList ? _self.seriesSequenceList : seriesSequenceList // ignore: cast_nullable_to_non_nullable
as String?,progress: freezed == progress ? _self.progress : progress // ignore: cast_nullable_to_non_nullable
