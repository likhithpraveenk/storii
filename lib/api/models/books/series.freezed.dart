...
mixin _$Series {
 ...
 List<LibraryItem> get books; int? get numBooks;// Sequence & Sorting
...
class _Series implements Series {
  const _Series({required this.id, required this.name, this.libraryId, this.nameIgnorePrefix, this.description, this.addedAt, this.updatedAt, final  List<LibraryItem> books = const [], this.numBooks, this.sequence, this.seriesSequenceList, this.progress, this.inProgress, this.hasActiveBook, this.hideFromContinueListening, this.bookInProgressLastUpdate, this.firstBookUnread, this.rssFeed}): _books = books;
