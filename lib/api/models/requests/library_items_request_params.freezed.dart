...
mixin _$LibraryItemsRequestParams {
 ...
 int? get limit; int? get page;@SortConverter() LibraryItemSort? get sort;@BoolBinaryConverter() bool? get desc;@FilterConverter() Filter? get filter;@JsonKey(name: 'collapseseries') bool? get collapseSeries;
...
@useResult
$Res call({
 int? limit, int? page,@SortConverter() LibraryItemSort? sort,@BoolBinaryConverter() bool? desc,@FilterConverter() Filter? filter,@JsonKey(name: 'collapseseries') bool? collapseSeries
});
...
/// Create a copy of LibraryItemsRequestParams
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? limit = freezed,Object? page = freezed,Object? sort = freezed,Object? desc = freezed,Object? filter = freezed,Object? collapseSeries = freezed,}) {
  return _then(_self.copyWith(
limit: freezed == limit ? _self.limit : limit // ignore: cast_nullable_to_non_nullable
as int?,page: freezed == page ? _self.page : page // ignore: cast_nullable_to_non_nullable
as int?,sort: freezed == sort ? _self.sort : sort // ignore: cast_nullable_to_non_nullable
as LibraryItemSort?,desc: freezed == desc ? _self.desc : desc // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int? limit,  int? page, @SortConverter()  LibraryItemSort? sort, @BoolBinaryConverter()  bool? desc, @FilterConverter()  Filter? filter, @JsonKey(name: 'collapseseries')  bool? collapseSeries)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _LibraryItemsRequestParams() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int? limit,  int? page, @SortConverter()  LibraryItemSort? sort, @BoolBinaryConverter()  bool? desc, @FilterConverter()  Filter? filter, @JsonKey(name: 'collapseseries')  bool? collapseSeries)  $default,) {final _that = this;
switch (_that) {
case _LibraryItemsRequestParams():
return $default(_that.limit,_that.page,_that.sort,_that.desc,_that.filter,_that.collapseSeries);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int? limit,  int? page, @SortConverter()  LibraryItemSort? sort, @BoolBinaryConverter()  bool? desc, @FilterConverter()  Filter? filter, @JsonKey(name: 'collapseseries')  bool? collapseSeries)?  $default,) {final _that = this;
switch (_that) {
case _LibraryItemsRequestParams() when $default != null:
return $default(_that.limit,_that.page,_that.sort,_that.desc,_that.filter,_that.collapseSeries);case _:
  return null;
...
class _LibraryItemsRequestParams extends LibraryItemsRequestParams {
  const _LibraryItemsRequestParams({this.limit, this.page, @SortConverter() this.sort, @BoolBinaryConverter() this.desc, @FilterConverter() this.filter, @JsonKey(name: 'collapseseries') this.collapseSeries}): super._();
  

@override final  int? limit;
@override final  int? page;
@override@SortConverter() final  LibraryItemSort? sort;
...
/// Create a copy of LibraryItemsRequestParams
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? limit = freezed,Object? page = freezed,Object? sort = freezed,Object? desc = freezed,Object? filter = freezed,Object? collapseSeries = freezed,}) {
